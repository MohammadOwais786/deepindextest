...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-157541159-1"></script>
...
<body data-spy="scroll" data-offset="80">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto w-100 justify-content-end">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#intergration-capabilities">Integration</a>
                                </li>
    ...
    <section id="iq-home" class="iq-banner overview-block-pt iq-bg-over iq-over-blue-90 jarallax" data-jarallax-video="m4v:./video/01.m4v,webm:./video/01.webm,ogv:./video/01.ogv">
        <div class="container-fluid">
            <div class="banner-text">
                <div class="row">
                    <div class="col-lg-6">
                        <h1 class="iq-font-white iq-tw-4">AI-Driven Video<b class="iq-tw-6"> Intelligence </b>Platform</h1>
                        ...
                        <button type="button" class="btn btn-light"><a href="#contact">Contact us</a></button>
                        <!-- <div class="waves-box">
    ...
    <div class="main-content">
                    ...
                    <div class="col-md-12 col-lg-4 r-mt-30">
                        <a class="scroll" href="#semantic-search-engine">
                            <div class="iq-works-box text-left">
                                ...
                                <p>Enhance Search Capabilities - Let your audience find relevant content faster, with topical search queries, instead of specific keywords. Our state-of-the-art NLP algorithms use the semantic search on content metadata to
                                    increase relevance and response time.
                                </p>
                            </div>
                        </a>
                    </div>
        ...
        <section id="advanced" class="overview-block-ptb how-works iq-mt-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-sm-5">
                        <div class="iq-services-box text-left iq-font-white">
                            ...
                            <div class="services-content">
                                ...
                                <p>Analyze your content at an amazing speed to use it for solutions like content moderation - sensual, explicit nudity, violence, substance use, and foul language. The platform provides actionable insights on your content
                                    through the exhaustive metadata captured.</p>
        ...
        <section id="intergration-capabilities" class="overview-block-ptb grey-bg">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <h3 class="title iq-tw-7">Integration Capabilities</h3>
                ...
                <div class="row display-center">
                    <div class="col-sm-12 col-lg-4 col-md-6 r4-mt-30">
                        <div class="iq-fancy-box text-center">
                            ...
                            <div class="fancy-content">
                                <h6 class="iq-tw-5 iq-pt-20 iq-pb-10">API First approach</h6>
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-6 r-mt-30 iq-mt-30">
                        <div class="iq-fancy-box text-center">
                            <div class="iq-icon">
                                <img src="images/services/modular.svg" alt="#">
                            </div>
                            <div class="fancy-content">
                                <h6 class="iq-tw-5 iq-pt-20 iq-pb-10">Extendable and modular</h6>
                                <!-- <p>Lorem ipsum madolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-4 col-md-6 iq-mt-30">
                        <div class="iq-fancy-box text-center">
                            ...
                            <div class="fancy-content">
                                <h6 class="iq-tw-5 iq-pt-20 iq-pb-10">Thorough API Documentation</h6>
                                <!-- <p>Lorem ipsum madolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-md-8 col-lg-8" style="margin: auto;">
                        <div class="iq-get-in">
                            ...
                            <form id="contact" method="post" action="homepage">
                                <div class="contact-form">
                                    ...
                                    <div class="section-field iq-mt-20">
                                        <div class="g-recaptcha" data-sitekey="6LfjDNUUAAAAAPAcWAOcDUfNKAKcnJxye9pqU6eu"></div>
                                    </div>
